...
const restaurantes = [
  {
    ...
    descripcion: "Burgers artesanales y snacks",
    ...
    productos: [
      {
        ...
        descripcion:
          "Bollo de mantequilla, 150gr de carne de res calidad USDA CHOICE con receta original, queso cheddar y queso Monterrey Jack.",
        imagen:
          "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&w=1200&q=80",
        variantes: [
          { id: "sencilla", nombre: "Sencilla", precio: 170 },
          { id: "doble", nombre: "Doble", precio: 210 }
        ],
        extras: [
          { id: "cebolla", nombre: "Cebolla caramelizada", precio: 15 },
          { id: "aros", nombre: "Aros de cebolla", precio: 15 },
          { id: "bbq", nombre: "Salsa BBQ", precio: 15 }
        ]
      },
      {
        id: 2,
        ...
        descripcion:
          "Medio aguacate cortado en abanico, 150gr de carne, queso Monterrey Jack y queso cheddar.",
        imagen:
          "https://images.unsplash.com/photo-1550547660-d9450f859349?auto=format&fit=crop&w=1200&q=80",
        variantes: [
          { id: "sencilla", nombre: "Sencilla", precio: 189 },
          { id: "doble", nombre: "Doble", precio: 229 }
        ],
        extras: [
          { id: "tocino", nombre: "Tocino", precio: 20 },
          { id: "papas", nombre: "Papas extra", precio: 25 }
        ]
      },
      {
        id: 3,
        ...
        descripcion:
          "2 jalapeños poppers jumbo, 150gr de carne, queso cheddar, queso Monterrey Jack, vegetales y sweet sriracha.",
        imagen:
          "https://images.unsplash.com/photo-1520072959219-c595dc870360?auto=format&fit=crop&w=1200&q=80",
        variantes: [
          { id: "sencilla", nombre: "Sencilla", precio: 190 },
          { id: "doble", nombre: "Doble", precio: 230 }
        ],
        extras: [
          { id: "jalapenos", nombre: "Jalapeños extra", precio: 15 },
          { id: "queso", nombre: "Queso extra", precio: 20 }
        ]
      }
    ]
  },
    ...
    productos: [
      {
        ...
        variantes: [
          ...
          { id: "grande", nombre: "Grande", precio: 230 }
        ],
        extras: [
          { id: "queso", nombre: "Queso extra", precio: 20 },
          { id: "orilla", nombre: "Orilla rellena", precio: 30 }
        ]
      },
      {
        id: 2,
        ...
        variantes: [
          { id: "regular", nombre: "Regular", precio: 90 },
          { id: "grande", nombre: "Grande", precio: 120 }
        ],
        extras: [
          { id: "cheddar", nombre: "Cheddar extra", precio: 15 },
          { id: "tocino", nombre: "Tocino", precio: 20 }
        ]
      }
    ]
  },
  {
    ...
    descripcion: "Tacos, quesadillas y volcanes",
    telefono: TELEFONO_PEDIDOS,
    horario: {
      abierto: "18:00",
      cerrado: "01:00"
    ...
    productos: [
      {
        ...
        descripcion:
          "Cinco tacos al pastor con cebolla, cilantro y salsa de la casa.",
        imagen:
          "https://images.unsplash.com/photo-1613514785940-daed07799d9b?auto=format&fit=crop&w=1200&q=80",
        variantes: [
          { id: "5tacos", nombre: "5 tacos", precio: 95 },
          { id: "10tacos", nombre: "10 tacos", precio: 180 }
        ],
        extras: [
          { id: "piña", nombre: "Piña extra", precio: 10 },
          { id: "queso", nombre: "Queso gratinado", precio: 20 }
        ]
      },
      {
        id: 2,
        ...
        descripcion:
          "Quesadilla grande de maíz con carne a elegir y queso derretido.",
        imagen:
          "https://images.unsplash.com/photo-1618040996337-56904b7850b9?auto=format&fit=crop&w=1200&q=80",
        variantes: [
          { id: "pastor", nombre: "Pastor", precio: 65 },
          { id: "asada", nombre: "Asada", precio: 75 }
        ],
        extras: [
          { id: "guacamole", nombre: "Guacamole", precio: 15 },
          { id: "frijoles", nombre: "Frijoles charros", precio: 20 }
        ]
      }
    ]
  },
  {
    id: 4,
    nombre: "Sushi Nori",
    descripcion: "Rollos, bowls y entradas orientales",
    telefono: TELEFONO_PEDIDOS,
    horario: {
      abierto: "14:00",
      cerrado: "21:30"
    ...
    productos: [
      {
        ...
        descripcion:
          "Rollo clásico con pepino, aguacate, queso crema y surimi.",
        imagen:
          "https://images.unsplash.com/photo-1579871494447-9811cf80d66c?auto=format&fit=crop&w=1200&q=80",
        variantes: [
          { id: "natural", nombre: "Natural", precio: 135 },
          { id: "empanizado", nombre: "Empanizado", precio: 155 }
        ],
        extras: [
          { id: "chipotle", nombre: "Aderezo chipotle", precio: 12 },
          { id: "camaron", nombre: "Camarón extra", precio: 25 }
        ]
      },
      {
        id: 2,
        ...
        variantes: [
          { id: "regular", nombre: "Regular", precio: 145 },
          { id: "grande", nombre: "Grande", precio: 185 }
        ],
        extras: [
          { id: "siracha", nombre: "Sriracha", precio: 10 },
          { id: "queso", nombre: "Queso crema", precio: 15 }
        ]
      }
    ]
  }
...
function App() {
  ...
  const [carrito, setCarrito] = useState(() => {
    const guardado = localStorage.getItem("talpaEatsCarrito")
    return guardado
      ? JSON.parse(guardado)
      : {
          restauranteId: null,
  ...
  const [datosCliente, setDatosCliente] = useState(() => {
    const guardado = localStorage.getItem("talpaEatsDatosCliente")
    return guardado
      ? JSON.parse(guardado)
      : {
          nombre: "",
  ...
  useEffect(() => {
    localStorage.setItem("talpaEatsCarrito", JSON.stringify(carrito))
  }, [carrito])

  useEffect(() => {
    localStorage.setItem("talpaEatsDatosCliente", JSON.stringify(datosCliente))
  }, [datosCliente])
  ...
  useEffect(() => {
    ...
    if (mpStatus === "success") {
      alert("Pago aprobado en Mercado Pago.")
    }
    if (mpStatus === "pending") {
      alert("Tu pago quedó pendiente.")
    }
    if (mpStatus === "failure") {
  ...
  const validarCheckout = () => {
    ...
    if (
      ...
      alert("Escribe con cuánto te pagan.")
      return false
    }
  ...
  const obtenerTextoMetodoPago = () => {
    switch (datosCliente.metodoPago) {
      ...
      case "online":
        return ultimoPago?.id
          ? `Pago en línea con tarjeta (Mercado Pago) - preferencia ${ultimoPago.id}`
          : "Pago en línea con tarjeta (Mercado Pago)"
      default:
        return "No definido"
    }
  }
...
Notas: ${datosCliente.notas || "Sin notas"}`
    ...
    const telefonoDestino = restauranteDelCarrito?.telefono || TELEFONO_PEDIDOS
...
>
            <div style={estilos.columnaCheckout}>
              ...
              <div style={estilos.cardFormulario}>
                ...
                <div style={estilos.listaMetodosPago}>
                  <button
                    style={{
                  ...
                  {ultimoPago?.id && (
                    <div style={estilos.avisoPagoCreado}>
                      Preferencia creada: <strong>{ultimoPago.id}</strong>
                    </div>
                  )}
                </div>
              </div>
    ...
    return (
      <div style={estilos.paginaMenu}>
        <div style={estilos.contenedor}>
          ...
          {restauranteSeleccionado.productos.map((producto) => (
            <button
              key={producto.id}
              style={{
